...
export function FlightPlanCard({
  ...
  return (
    ...
    >
      ...
      {flight.standbyAt && (
        <p className="mt-1.5 border-t border-zinc-800 pt-1.5 text-[12px] text-warn">
          En standby desde las {formatTime(flight.standbyAt)}
          {flight.standbyBy ? ` · lo puso ${flight.standbyBy}` : ""}
        </p>
      )}
